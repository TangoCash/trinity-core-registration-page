...
if ($charid != null) {
    ...
    for ($x = -1; $x <= 18; $x += 1) {
        ...
        if (
            $itemresult = mysqli_query(
                $DB_CH,
                "SELECT * FROM character_inventory WHERE guid = $charid AND bag = 0 AND slot = $x"
            )
        ) {
                ...
                if (
                    ...
                    while ($itemrow = mysqli_fetch_assoc($itemresult)) {
                        ...
                        if (
                            $itemresult = mysqli_query(
                                $DB_W,
                                "SELECT * FROM item_template WHERE entry = $item_id"
                            )
                        ) {
                            while ($itemrow = mysqli_fetch_assoc($itemresult)) {
                                ...
                                $url =
                                    "https://www.wowhead.com/wotlk/de/item=" .
                                    $item_id .
                                    "&xml";
    ...
    if (
        $stats_result = mysqli_query(
            $DB_CH,
            "SELECT * FROM characters WHERE guid=" . $charid
        )
    ) {
        //echo "Returned rows are: " . mysqli_num_rows($stats_result);
        ...
        <body>          
            ...
            <div class="grid-container center">
                <div class="grid-item item-head tooltip">
                        <?php if ($head_id != null) {
                            ...
                            echo "<img alt='" .
                                ...
                                "' height='64' src='" .
                                $head_icon .
                                "' style='border-width: 0px' width='64'></a>";
                        } ?>
                    <span class="tooltiptext">Head</span>
                ...
                <div class="grid-item item-name">
                    <div class="grid-container-main">
                        <div class="grid-item-main main-item-race tooltip">
                            <?php if ($charid != null) {
                                echo "<img height=\"64\" src=\"./assets/img/race/" .
                                    $info_race .
                                    "-" .
                                    $info_gender .
                                    ".gif\" width=\"64\">";
                            } ?>
                            <span class="tooltiptext">Race</span></div>
                        ...
                        <div class="grid-container-main-info">
                            ...
                            <div class="grid-item-main-info"></div>
                            <div class="grid-item-main-info"><?php if (
                                $info_level != null
                            ) {
                        ...
                        <div class="grid-item-main main-item-class tooltip">
                            <?php if ($charid != null) {
                                echo "<img height=\"64\" src=\"./assets/img/class/" .
                                    $info_class .
                                    ".gif\" width=\"64\">";
                            } ?>

                            <span class="tooltiptext">Class</span></div>
                    </div>
                </div>
                <div class="grid-item item-hands tooltip">
                    ...
                    <span class="tooltiptext">Hands</span>
                </div>
                ...
                <div class="grid-item item-neck tooltip">
                    ...
                    <span class="tooltiptext">Neck</span>
                </div>
                <div class="grid-item item-stats stats-bg-image" style="color: white;">Stats<br>
                ...
                <div class="grid-item item-waist tooltip">
                    ...
                    <span class="tooltiptext">Waist</span>
                </div>
                ...
                <div class="grid-item item-shoulders tooltip">
                    ...
                    <span class="tooltiptext">Shoulders</span>
                </div>
                <div class="grid-item item-legs tooltip">
                    ...
                    <span class="tooltiptext">Legs</span>
                </div>
                ...
                <div class="grid-item item-feet tooltip">
                    ...
                    <span class="tooltiptext">Feet</span>
                </div>
                ...
                <div class="grid-item item-chest tooltip">
                    ...
                    <span class="tooltiptext">Chest</span>
                </div>
                ...
                <div class="grid-item item-shirt tooltip">
                    ...
                    <span class="tooltiptext">Shirt</span>
                </div>
                ...
                <div class="grid-item item-tabard tooltip">
                    ...
                    <span class="tooltiptext">Tabard</span>
                </div>
                <div class="grid-item item-trinket1 tooltip">
                    ...
                    <span class="tooltiptext">Trinket 1</span>
                </div>
                ...
                <div class="grid-item item-wrists tooltip">
                    ...
                    <span class="tooltiptext">Wrists</span>
                </div>
                <div class="grid-item item-trinket2 tooltip">
                    ...
                    <span class="tooltiptext">Trinket 2</span>
                </div>
                ...
                <div class="grid-item item-mainhand tooltip">
                    <?php if ($mainhand_id != null) {
                        echo "<a href='" .
                            ...
                            $mainhand_id .
                            "' target='_blank'>";
                        echo "<img alt='' height='64' src='" .
                            $mainhand_icon .
                            "' style='border-width: 0px' width='64'></a>";
                    } ?>
                    <span class="tooltiptext">Main Hand</span>
                </div>
                <div class="grid-item item-offhand tooltip">
                    ...
                    <span class="tooltiptext">Off Hand</span>
                </div>
